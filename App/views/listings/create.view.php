...
<section class="flex justify-center items-center mt-20">
  <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-600 mx-6">
    ...
    <form method="POST" action="/listings">
      ...
      <p>please contact admin jeyalakshmi@sunflexglobal.com for a team collaboration...</p>
      <div class="mb-4">
      ...
      <div class="mb-4">
        <input type="text" name="salary" placeholder="Hourly Salary" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $listing['salary'] ?? '' ?>" />
      </div>
      <div class="mb-4">
